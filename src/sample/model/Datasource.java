...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\Ihs\\Project pro\\IntelliJ\\Music\\" + DB_NAME;
    ...
    public static final String COLMUMN_SONG_ID = "id";
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        // SELECT albums.name FROM albums INNER JOIN aritsts ON albums.artist = artists._id WHERE artists.name = "Carole King" ORDER BY albums.name COLLATE NOCASE ASC
...
//            sb.append(" COLLATE NOCASE ");
    ...
    public boolean createViewForSongArtists() {
        ...
        try(Statement statement = conn.createStatement()) {
            ...
            System.out.println("Crete View Failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Oh boy! Things are not going well! " + e2.getMessage());
            }
        } finally {
            try {
